...
const Footer = () => {
  // to display the current year for the footer
  let theDate = new Date();
  const theCurrentYear = theDate.getFullYear()

  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-black">
    <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
        <div className="w-full text-5xl font-bold">
            <h1 className="w-full md:w-2/3">With Us, Clearing your goods become easier and faster.</h1>
        </div>
        <div className="flex mt-8 flex-col md:flex-row md:justify-between">
            ...
            <div className="w-44 pt-6 md:pt-0">
                <Link to="/contact-us" className="bg-[#22c55e] justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">Get in Touch</Link>
            </div>
        </div>
        <div className="flex flex-col">
            <div className="flex mt-24 mb-12 flex-row justify-between items-center">
                <div className="">
                    <Link to='/' className="text-3xl text-[#22c55e] font-mono font-bold">Hisrael</Link>  
                </div>
                ...
                <Link to="/services"  className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Services</Link>
                <Link to="/blog"  className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Blog</Link>
            ...
            <p class="w-full text-center my-12 text-gray-600">Copyright © {theCurrentYear} Hisrael Freight & Forwarding</p>
        </div>
    </div>
</div>  )
}
